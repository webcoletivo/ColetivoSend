  ...
  return (
    <div className="min-h-screen bg-muted/30 dark:bg-background">
      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-12">
              ...
              <div className="sticky top-32 space-y-1">
                ...
                {sections.map(section => (
                  <button
                    ...
                    className="block w-full text-left px-2 py-1.5 text-sm text-muted-foreground hover:text-primary-500 hover:bg-primary-500/10 rounded-lg transition-colors"
                  >
                    {section.label}
                  </button>
                ))}
            ...
            {/* Content */}
            <article className="flex-1 prose prose-slate dark:prose-invert prose-headings:scroll-mt-32 max-w-none">
              ...
              <section id="data" className="mb-12">
                ...
                <div className="grid sm:grid-cols-2 gap-4 not-prose mb-6">
                  <div className="p-4 bg-card rounded-xl border border-border shadow-sm">
                    ...
                    <p className="text-sm text-muted-foreground">Nome, e-mail e senha (criptografada) para usuários cadastrados.</p>
                  </div>
                  <div className="p-4 bg-card rounded-xl border border-border shadow-sm">
                    <div className="flex items-center gap-2 font-semibold text-foreground mb-2">
                    ...
                    <p className="text-sm text-muted-foreground">Metadados dos arquivos (nome, tamanho, tipo), e-mail do destinatário e mensagem opcional.</p>
                  </div>
                </div>
                <p>
              ...
              <section id="storage" className="mb-12">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 my-4 not-prose">
                  <h4 className="font-semibold text-amber-600 dark:text-amber-400 mb-1">Deleção Automática</h4>
              ...
              <section id="cookies" className="mb-12">
                <h2>7. Cookies</h2>
                <div className="flex items-start gap-4 p-4 bg-muted/50 rounded-xl border border-border not-prose">
                  <Cookie className="w-6 h-6 text-muted-foreground mt-1" />
                  <div>
              ...
              <section id="contact" className="mb-12">
                ...
                <a href="mailto:privacidade@grupocoletivo.com.br" className="inline-flex items-center gap-2 text-primary-500 hover:text-primary-600 font-medium no-underline">
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary-500 text-white rounded-full shadow-lg flex items-center justify-center hover:bg-primary-600 transition-colors z-40"
